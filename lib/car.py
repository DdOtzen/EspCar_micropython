...
class Car:
    ...
    _rightMotor = Motor(Pins.Motor.Right)
    _leftMotor = Motor(Pins.Motor.Left)
    ...
    def __init__(self):
        ...
        self.lys = self.light
        self.kortLys = self.light.kortLys
        self.langLys = self.light.langLys
        ...
        self.højreLys = self.light.rightLights
        self.KORT_LYS = self.light.LOW_BEAM
        self.LANGT_LYS = self.light.HIGH_BEAM
        self.VENSTRE = self.light.LEFT
        self.HOEJRE = self.light.RIGHT
        self.SLUK = self.light.OFF
        ...
        # ligeud controller stuff with really ugly names
    ...
    def Emergency_shutdown(cls):
        ...
        cls.light.EmergencyBlink()

    def EnableBlinkRelay(self):
        self._scheduling.addCb100(self.light.blinkingTick)
